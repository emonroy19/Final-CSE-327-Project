...
//calender show deshbord
Route::get('/all-calender','EventController@all_calender');


//Admin Authentication check
Route::get('/admin-auth-check','AdminController@AdminAuthCheck');
Route::get('/admin-auth-check','SuperAdminController@AdminAuthCheck');
Route::get('/admin-auth-check','EventController@AdminAuthCheck');
Route::get('/admin-auth-check','UserController@AdminAuthCheck');